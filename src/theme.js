...
export const theme = {
  ...
  // Buttons & Controls
  buttonPrimary: "bg-primary hover:bg-primary-hover text-white px-8 py-4 rounded-full font-bold transition-all shadow-[0_0_20px_rgba(255,90,0,0.4)]",
  buttonSecondary: "bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-full font-bold border border-white/20 transition-all",
  ...
  badge: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#ffefe8] border border-[#ffdbcd] text-primary text-xs sm:text-sm font-semibold tracking-wide uppercase",
};
