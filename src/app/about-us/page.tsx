...
export default function AboutUsPage() {
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 max-w-6xl ">
            ...
            <div className="w-full md:w-[45%] flex justify-center items-center mt-8 md:mt-0">
              <div className="w-full max-w-md md:max-w-none rounded-[24px] overflow-hidden border-4 border-primary/20 shadow-xl shrink-0">
                <Image
                  src="/images/pages2/sirupdated.webp"
                  alt="Mr Manoj Padmanabhan, Founder & CEO"
                  width={890}
                  height={1000}
                  className="w-full h-[280px] sm:h-[320px] md:h-[380px] lg:h-[420px] object-cover object-top"
                />
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 mt-12 sm:mt-16 mb-20 sm:mb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <div className="group relative flex flex-col justify-start px-8 py-10 bg-[#f4f5f7] rounded-[24px] shadow-sm w-full h-full border border-gray-100 hover:border-primary hover:shadow-lg hover:-translate-y-2 transition-all duration-400 overflow-hidden cursor-pointer">
            ...
            <div className="relative z-10 w-full flex flex-col">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 flex items-center justify-center rounded-full border-[2px] border-white shadow-[0_0_15px_rgba(255,255,255,0.7)] bg-transparent group-hover:bg-[#0b132a] group-hover:shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:scale-110 transition-all duration-300">
                  <Settings className="w-6 h-6 sm:w-7 sm:h-7 text-primary group-hover:text-white transition-colors duration-300 stroke-[1.5]" />
                </div>
                <h3 className={cn(theme.h3, "text-[18px] sm:text-[20px] group-hover:text-white transition-colors duration-300 m-0")}>
          ...
          <div className="group relative flex flex-col justify-start px-8 py-10 bg-[#f4f5f7] rounded-[24px] shadow-sm w-full h-full border border-gray-100 hover:border-primary hover:shadow-lg hover:-translate-y-2 transition-all duration-400 overflow-hidden cursor-pointer">
            ...
            <div className="relative z-10 w-full flex flex-col">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 flex items-center justify-center rounded-full border-[2px] border-white shadow-[0_0_15px_rgba(255,255,255,0.7)] bg-transparent group-hover:bg-[#0b132a] group-hover:shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:scale-110 transition-all duration-300">
                  <Users className="w-6 h-6 sm:w-7 sm:h-7 text-primary group-hover:text-white transition-colors duration-300 stroke-[1.5]" />
                </div>
                <h3 className={cn(theme.h3, "text-[18px] sm:text-[20px] group-hover:text-white transition-colors duration-300 m-0")}>
          ...
          <div className="group relative flex flex-col justify-start px-8 py-10 bg-[#f4f5f7] rounded-[24px] shadow-sm w-full h-full border border-gray-100 hover:border-primary hover:shadow-lg hover:-translate-y-2 transition-all duration-400 overflow-hidden cursor-pointer md:col-span-2 lg:col-span-1">
            ...
            <div className="relative z-10 w-full flex flex-col">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 flex items-center justify-center rounded-full border-[2px] border-white shadow-[0_0_15px_rgba(255,255,255,0.7)] bg-transparent group-hover:bg-[#0b132a] group-hover:shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:scale-110 transition-all duration-300">
                  <Server className="w-6 h-6 sm:w-7 sm:h-7 text-primary group-hover:text-white transition-colors duration-300 stroke-[1.5]" />
                </div>
                <h3 className={cn(theme.h3, "text-[18px] sm:text-[20px] group-hover:text-white transition-colors duration-300 m-0")}>
          ...
          <div className="group relative flex flex-col justify-start px-8 py-10 bg-[#f4f5f7] rounded-[24px] shadow-sm w-full h-full border border-gray-100 hover:border-primary hover:shadow-lg hover:-translate-y-2 transition-all duration-400 overflow-hidden cursor-pointer md:col-span-2 lg:col-span-1">
            ...
            <div className="relative z-10 w-full flex flex-col">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 flex items-center justify-center rounded-full border-[2px] border-white shadow-[0_0_15px_rgba(255,255,255,0.7)] bg-transparent group-hover:bg-[#0b132a] group-hover:shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:scale-110 transition-all duration-300">
                  <CheckCircle2 className="w-6 h-6 sm:w-7 sm:h-7 text-primary group-hover:text-white transition-colors duration-300 stroke-[1.5]" />
                </div>
                <h3 className={cn(theme.h3, "text-[18px] sm:text-[20px] group-hover:text-white transition-colors duration-300 m-0")}>
                  Beyond ERP
                </h3>
        ...
        {/* Approach Section */}
        <div className="mb-24 sm:mb-32 text-center mt-12 sm:mt-16">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-red-100/60 mb-6 bg-white shadow-sm">
            <div className="w-4 h-[3px] bg-primary rounded-full"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-12 gap-x-4 relative z-10">
              {[
                ...
                <div key={step.label} className="flex flex-col items-center group cursor-pointer relative">
                  ...
                  <h3 className={cn(theme.h3, "text-[17px] group-hover:text-primary transition-colors duration-300 text-center")}>
                    {step.label}
                  </h3>
                </div>
              ))}
        ...
        {/* Commitment & CTA */}
        <div className="mt-12 sm:mt-16 lg:mt-24 relative overflow-hidden bg-gradient-to-br from-[#0b132a] to-[#1a233a] rounded-[24px] sm:rounded-[32px] shadow-[0_20px_40px_rgba(0,0,0,0.1)] p-6 sm:p-10 lg:p-14 text-center border border-white/10">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className={cn(theme.p, "text-center !indent-0 mx-auto font-medium text-lg")}>
              &quot;Our goal is simple — make ERP work for your business, not the other way around.&quot;
            </p>
            <p className={cn(theme.p, "text-center !indent-0 mx-auto mt-6")}>
